    ...
    <>
      ...
      <table className="w-full text-base font-normal text-left text-white table-auto">
        <thead className="uppercase bg-black">
          <tr>
            ...
            <th scope="col" className="px-2 py-4 font-normal ">
              Destination
            </th>
        ...
        <tbody className="">
          {rowRenderer({
            data: null, //The data to be passed
            index: 1, // The index of the data (leave as index)
            handleOpenModal, //This is the open modal funcction
            handleSetMenuToggle, //This is the menu/action items toggle function
            menuToggle, //This is the menu/action items toggle function
            menuVisible, //This is the menu/action items toggle function
            handleOpenDeleteModal, //This shows the delete Modal Functionality for the action menu
            setFlip, //Sets the flip
          })}
        </tbody>
      </table>
      ...
      {flip === "create"
            ...
            >
              <div className="grid w-full grid-cols-2 gap-8 pb-12 mt-12">
                ...
                <div>
                  ...
                  <div className="text-lg">Departure Time</div>
                </div>
                <div>
                  <div className="mb-1 text-sm font-normal text-gray-400">
                    Date
                  </div>
                  <div className="text-lg">Departure Data</div>
                </div>
                <div>
                  <div className="mb-1 text-sm font-normal text-gray-400">
                    Driver
                  </div>
                  <div className="text-lg">Driver's full name</div>
                </div>
                <div>
                  <div className="mb-1 text-sm font-normal text-gray-400">
                    Vehicle
                  </div>
                  <div className="text-lg">Bus Name</div>
                </div>
              </div>
              <Button
                title="Edit"
        ...
        ? modalVisible && (
            <Modal
              title={
                <div className="text-lg font-medium boder-b">Edit Trip</div>
              }
              onOk={handleOk}
              onCancel={handleCancel}
              open={true}
