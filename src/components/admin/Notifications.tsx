...
const RightSidebar: React.FC = () => {
  ...
  return (
    <div className="fixed px-4 py-2 top-0 right-0 pt-24 w-2/12 h-screen col-start-5 col-end-6 bg-[#EFF3EF] border-l">
        ...
        <div className="mt-4 pb-16">
          {notifications.map((notification, index) => {
            return (
              <div
                key={index}
                className="flex overflow-hidden border-b py-2 my-2 text-base text-gray-800"
              >
