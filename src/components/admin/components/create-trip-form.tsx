    ...
    <div className="">
      ...
      <div>
        ...
        <div className="flex items-center w-full mt-2">
          <div className="w-1/4 px-4 py-2 mr-2 text-white text-sm bg-black rounded-md ">
            City
          </div>
                    ...
                    .map((city: City_interface) => {
                      return (
                        <a
                          key={city?._id}
                          href="#"
                          className="inline-block text-sm w-full px-4 py-2 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-900"
                          onClick={() => {
      ...
      {/* DESTINATION */}
      <div className="mt-3">
        <p className="w-full text-gray-500 text-sm ">Destination</p>
        <div className="flex items-center w-full mt-2">
          <div className="w-1/4 px-4 py-2 mr-2 text-white text-sm bg-black rounded-md ">
            City
          </div>
      ...
      <div className="text-sm  w-full pb-2 mt-3 text-gray-500">
      ...
      <div className="w-full text-sm  pb-2 mt-3 text-gray-500">
        Arrival Date and time
      </div>
      <EndDateField
      ...
      {/* PRICE */}
      <div className="mt-3">
        <p className="w-full text-gray-500 text-sm ">Price</p>
        <div className="flex items-center w-full mt-2 ">
          <div className="w-1/4 px-4 py-2 mr-2 text-white text-sm bg-black rounded-md ">
            Price
          </div>
