    ...
    <div className="pt-32">
      ...
      <div className="lg:mx-[120px] pb-24 lg:pb-0 text-[13px]">
        <div className="lg:grid lg:grid-cols-8 lg:gap-8">
          ...
          >
            <div className="lg:fixed lg:w-2/6 flex rounded-t-md pt-4 px-4 text-white bg-black border-b pb-6">
              <div className="">
            ...
            <div className="w-full lg:mt-24 px-4 pt-4 pb-4 rounded-md lg">
              <div className="mb-8">
