    ...
    <Layout>
      ...
      <div className="fixed w-full content-center margin-auto justify-left grid mx-[120px] my-[120px]">
        <div className="flex w-3/4">
          <div className="grid divide-gray-200 w-2/5 h-[480px] overflow-auto bg-white rounded-md">
          ...
          <div className="w-3/4 flex h-5/6 pb-16 overflow-y-scroll scroll-behavior-smooth ease-in-out duration-300 ml-6 bg-white rounded-md ">
            <div className="h-full ">
              {termsofservicedata?.map((tosData) =>
                selectedContent === tosData.key ? (
                  <div className="w-full pb-8">
                    <div className="w-2/3 mx-8 mt-8">
