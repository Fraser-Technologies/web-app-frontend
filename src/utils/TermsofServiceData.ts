export const termsofservicedata = [
  ...
  },
  {
    ...
    text: "Our website may be updated and modified periodically to reflect changes in our product and service offerings, user needs, and business priorities. It is important that you review these terms and conditions every time you visit our website to ensure that you understand the terms that apply at that time.\n While we strive to maintain the availability of our website and its content, we cannot guarantee that it will always be available or free from interruptions. There may be instances where we need to suspend or withdraw access to all or part of the website for business or operational reasons. In such cases, we will make every effort to provide you with reasonable notice of any suspension or withdrawal. \n Please note that your use of our website is subject to these terms and conditions, as well as any additional terms and conditions that may be posted on specific pages of the website. By accessing and using our website, you agree to be bound by these terms and conditions. If you do not agree with any of these terms and conditions, you should not use our website.",
  },
  {
    key: "accountDetails",
